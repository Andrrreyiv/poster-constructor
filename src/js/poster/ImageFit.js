...
// ⛔ Здесь был cropLoss — доля картинки, уходящая в обрез. Удалён 13.09: он был написан
// впрок, ни разу не вызывался, а показывать покупателю «от вашего фото останется треть»
// клиент не просил. Переключатель ориентации делает сильный обрез редким случаем.
// Понадобится — считается из coverRect в три строки.
